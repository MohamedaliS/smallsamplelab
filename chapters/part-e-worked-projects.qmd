...
# Estimate indirect effect via bootstrap (500 iterations for rendering)
med_out <- mediate(
  model_m,
  model_y,
  treat = "intervention",
...
# Bootstrap mediation (500 iterations for rendering)
med_out_cov <- mediate(
  model_m_cov,
  model_y_cov,
  treat = "intervention",
